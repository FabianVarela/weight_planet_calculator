...
const vec3 LAND_COLOR = vec3(0.55, 0.48, 0.40);
const vec3 JUNGLE_COLOR = vec3(0.50, 0.44, 0.37);
const vec3 DESERT_COLOR = vec3(0.70, 0.63, 0.55);
const vec3 SNOW_COLOR = vec3(0.78, 0.73, 0.68);

const float OCEAN_SIZE = 0.0;
const vec3 OCEAN_COLOR = vec3(0.45, 0.40, 0.34);

const vec3 ATMOSPHERE_COLOR = vec3(0.0);
const float ATMOSPHERE_DENSITY = 0.0;

const vec3 DAWN_COLOR = vec3(0.0);
const vec3 SUNSET_COLOR = vec3(0.0);
const vec3 CLOUD_COLOR = vec3(1.0);

const float AMBIENT_LIGHT = 0.02;
const float SHADOW_STRENGTH = 0.0;

const vec3 LIGHT1_POS = vec3(12, 2, -4);
const vec4 LIGHT1_COLOR = vec4(1.0, 0.98, 0.92, 1.6);

const vec3 LIGHT2_POS = vec3(-8, -4, 6);
const vec4 LIGHT2_COLOR = vec4(0.3, 0.28, 0.25, 0.08);
